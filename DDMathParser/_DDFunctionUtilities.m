...
double DDConvertUnits( double value, DDParserUnits from, DDParserUnits to )
{
    double unit_conv[6][6] =
    {
        // to
        // inch    mm         mil       cm        ft         m
        {1.,       25.4,      1000,    2.54,       12,    1/0.0254 },  // inch  from
        {1/25.4,     1.,  1/0.0254,  1/10.0,  1/304.8,      1/1000.},  // mm
        {1/1000, 0.0254,        1.,  0.2540, 1/12000., 1/0.0000254 },  // mils
        {1/2.54,     10,  1/0.2540,      1.,  1/30.48,       1/100.},  // cm
        {1/12.,   304.8,     12000,   30.48,       1.,      0.3048 },  // ft
        {0.0254,   1000, 0.0000254,     100,  1/.3048,           1.},  // m
    };
